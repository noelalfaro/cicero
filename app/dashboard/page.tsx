          ...
          <Card className="w-full">
            ...
            <CardContent>
              <div className="text-balance">
                ...
                development. <br /> I welcome you to navigate to the different
                pages in the nav above or click on a link below to explore what
                a player's individual page currently looks like.
              </div>
