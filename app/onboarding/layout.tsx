      ...
      <AuthProvider>
        <html lang="en">
          <body className={` ${inter.className}`}>
            ...
            >
              <main className="container flex min-h-screen w-full max-w-7xl flex-col items-center px-[0.5rem] pt-2 md:justify-center lg:justify-start lg:px-[2rem] lg:pt-2">
                {children}
              </main>
            </ThemeProvider>
          </body>
