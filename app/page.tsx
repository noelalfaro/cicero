          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                ...
                surrounding a player by analyzing social media posts made about
                said player. This gets run through our ML model to determine a
                new stock price for each day. For a complete list of stats
                tracked and type of sentiment tracked, refer below.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
